...
Accounts.emailTemplates.resetPassword.html = function (user, resetPasswordUrl) {
    var options;
    console.log('raw', resetPasswordUrl);
    console.log(ironify(resetPasswordUrl));
    options = _.extend({}, PrettyEmail.defaults.resetPassword, {
        subject: Accounts.emailTemplates.resetPassword.subject(user),
        buttonUrl: ironify(resetPasswordUrl)
    });
    return PrettyEmail.render('call-to-action', options);
};
...
// don't ask me..... I didn't do it... creates a footer from options passed to pretty emails... I think ?
